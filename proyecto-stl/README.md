...
```
cd existing_repo
git remote add origin https://gitlab.com/grupo9894143/proyecto.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/grupo9894143/proyecto/-/settings/integrations)
